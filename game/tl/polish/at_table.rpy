...
translate crowdin first_at_table_preparation_612e2ac5:
    ...
    emy " Obiad jest prawie gotowy. Idź się przebrać, jeśli chcesz coś zjeść.”
...
translate crowdin at_table_dinner_A_cec7c78a:
    ...
    mc "{i}Mhmm, może powinienem przełamać lody gratulując [emy] kolacji. Ale nie wiem, czy to jest stosowne."
...
translate crowdin at_table_dinner_A_55e2a73e:
    ...
    mc " Wczoraj... Jeśli dobrze pamiętam... Graliśmy na [console] i rozmawialiśmy trochę o szkole i dawnych czasach.”
...
translate crowdin at_table_dinner_A_48606c77:
    ...
    mc "Ostatniej nocy [tam] nie było w domu, więc zamówiliśmy pizzę w [pizzeria]. Podczas gdy na śniadanie / lunch dostaliśmy na wynos w McDonald z [tam].”
...
translate crowdin at_table_dinner_A_c331f251:
    ...
    emy " To brzmi jak by [tam] bardzo nie chciał się gotować. Ha, haha... Jednak nie jest to zbyt zdrowe jedzenie.... więc nie przyzwyczajaj się do tego.”
...
translate crowdin at_table_dinner_A_2cc787ab:
    ...
    emy "Ty i [bff] jesteście bardzo dobrymi kolegami, wyglądacie prawie jak bracia. Nawet jeśli jesteś całkowicie inny. ” nointeract
...
translate crowdin at_table_dinner_A_9c64c2df:
    ...
    mc " Tak, jesteśmy bardzo blisko. Znam go od dawna a do tego mamy bardzo podobne doświadczenia."
...
translate crowdin at_table_dinner_A_d107a06b:
    ...
    mc "Tak. Jest niezawodnym przyjacielem. Nawet jeśli jest to trochę śmieszne i nudne."
...
translate crowdin at_table_dinner_A_64e91d02:
    ...
    mc "Tak, także dlatego, że nie byłem tu długo. Ale jestem pewien, że będę zarabiać więcej.”
...
translate crowdin at_table_dinner_A_bef7a488:
    ...
    mia "Tęsknisz za [old_city]? Mam na myśli, że zostawiłeś wszystkich, których znałeś za sobą."
...
translate crowdin at_table_dinner_A_a9510619:
    ...
    emy "[mia]! Nie zadawaj takich pytań. To oczywiste że nadal tęskni."
...
translate crowdin at_table_dinner_A_c848fd66:
    ...
    mc "Jebać [old_city] i wszystkich którzy tam mieszkają. Nic mi nie dało po za kłopotami."
...
translate crowdin at_table_dinner_A_ad72c338:
    ...
    mc " Wolałbym jeszcze o tym nie mówić, myślę, że zrozumiesz."
...
translate crowdin at_table_dinner_A_379631f0:
    ...
    emy "A co u Ciebie [mia]?! Jesteś gotowa na jutrzejszy egzamin?"
...
translate crowdin at_table_dinner_A_e6bdb60e:
    ...
    mia "Mhmm, tak... ale... profesor jest strasznie surowy. Jestem pewna że mnie nienawidzi."

# game/labels/at_table.rpy:124
translate crowdin at_table_dinner_A_aaa8f66c:

    # emy "Haha... yes of course, of course."
    emy "Haha... tak oczywiście, oczywiście."
...
translate crowdin at_table_dinner_A_9ce965a5:
    ...
    emy "Jestem pewna ze jeśli się uczyłaś zdasz to."
...
translate crowdin at_table_dinner_A_215aa469:
    ...
    mc "Świetny obiad. wszystko było dobre."
...
translate crowdin at_table_dinner_A_d1a58592:
    ...
    mc "{i}O nie! Prawdopodobnie powiedziała jej o moich ocenach."
...
translate crowdin at_table_dinner_A_2f443dab:
    ...
    emy "Jutro rano podwiezie cię do szkoły. Ponieważ ten drań zabrał też samochód."

# game/labels/at_table.rpy:168
translate crowdin at_table_dinner_A_c668a663:

    # mc "{i}Phew, danger averted."
    mc "{i}Phew, Niebezpieczeństwo zażegnane."
...
translate crowdin at_table_dinner_A_d2b56740:
    ...
    emy " Ale nie chcę być zbyt wielkim problemem. Jesteś już dużym chłopcem. Jutro cię podwiezie, ale będziesz musiał dokonać własnych uzgodnień. Powinieneś kupić bilet miesięczny, dam ci pieniądze na niego."

# game/labels/at_table.rpy:170
translate crowdin at_table_dinner_A_002abd73:

    # mc "Beh... we could use your car."
    mc " Beh... moglibyśmy użyć twoje samochodu."
...
translate crowdin at_table_dinner_A_b8c6c389:
    ...
    emy "Ten złom!? Kochanie, nie odpalaliśmy go od lat. Nie wiem czy jeszcze działa. Powinnam go najpierw sprawdzić."
...
translate crowdin at_table_dinner_A_part2_975ba825:
    ...
    emy "Nie chce tego mówić ponownie. Czy to jasne?" nointeract
...
translate crowdin at_table_dinner_A_part2_ded1eb5d:
    ...
    mc "Wszystko jasne, ale nie wiem gdzie kupić bilet miesięczny."
...
translate crowdin at_table_dinner_A_part2_1a1faa7b:
    ...
    emy "W dowolnym sklepie lub kiosku. Wiem że sprzedaje je sklepik w szkole."
...
translate crowdin at_table_dinner_A_part2_a528b8c6:
    ...
    mc "Możesz dać mi od razu pieniądze? Obawiam się że zapomnę później o tym."
...
translate crowdin at_table_dinner_A_part2_2bb66d88:
    ...
    emy "Nie! I nie chcę o nim rozmawiać na razie. Potrzebuje trochę rozrywki."

# game/labels/at_table.rpy:191
translate crowdin at_table_dinner_A_part2_24a822f7:

    # mc "Okay, all clear."
    mc "Okay, wszystko jasne."
...
translate crowdin at_table_dinner_A_part2_29c49ec9:
    ...
    emy "Dobry filmy jest tym czego potrzebujesz. Idę usiąść na kanapie, jak zechcesz dołącz do mnie. Jeszcze raz dziękuję za pomoc, kochanie."
...
translate crowdin strings:
    ...
    new "Nie chcę o tym rozmawiać"

    # game/labels/at_table.rpy:140
    old "[mia], if you need to review for tomorrow, go ahead. [mc] will help me clear the table. Right?!"
    new "[mia], jeśli potrzebujesz recenzji na jutro, śmiało. [mc] pomoże mi posprzątać ze stołu. Prawda?!"
    ...
    new "Chciał bym teraz dostać pieniądze"

    # game/labels/at_table.rpy:174
    old "Talk about [jn]"
    new "Porozmawiajmy o [jn]"
