...
translate crowdin strings:
    ...
    new "[jn], my [jnR.NPClabel], jest byłym żołnierzem Navy Seals. Jako chłopiec był twardzielem i buntownikiem, ale życie wojskowe go zmieniło."
    ...
    new "[emy], my [emyR.NPClabel], jest klasyczną kurą domową. Wyszła za mąż za [jn], gdy dowiedziałaś się, że jesteś w ciąży z [vct]."

    # game/values_text.rpy:14
    old "[vct] is the classic rebellious teenager."
    new "[vct] jest klasyczną zbuntowaną nastolatką."
    ...
    new "[mia] jest małą dziewczynką w domu. Jest tak gadatliwa, że trudno jej zachować tajemnice. Kiedy coś jest nie tak, mówi bardzo mało."

    # game/values_text.rpy:18
    old "[bff] is my [bffR.NPClabel]. We go to the same school and we are in the same class."
    new "[bff] jest moim [bffR.NPClabel]. Chodzimy do tej samej szkoły i jesteśmy w tej samej klasie."
