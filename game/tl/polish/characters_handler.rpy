...
# game/tool/characters_handler.rpy:77
...
translate polish customize_mc_family_64c7ff47:

    # "Who is [vct] to [emy] and [jn] (also applies to [mia] and [arn])?"
    "Kim jest [vct] dla [emy] i [jn] (dotyczy również [mia] i [arn])?"
...
translate polish renaming_friend_9d439fc7:
...
translate polish strings:
    ...
    old "mom's friend"
    new "przyjaciółka mamy"

    # game/tool/characters_handler.rpy:135
    old "dad's friend"
    new "przyjaciółka taty"
