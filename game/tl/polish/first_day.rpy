...
translate crowdin intro_ea546e9e:
    ...
    mc "Moja rodzina jest zaniepokojona moimi słabymi ocenami i niektórymi zachowaniami, dlatego zastanawiają się, czy zatrzymać mnie w domu, czy przenieść do znienawidzonej szkoły szkoły prywatnej [catholic_institute]. Muszę się upewnić, że to się nigdy nie zdarzy."
...
translate crowdin intro_308b7484:
    ...
    mc "Szczerze mówiąc, moja prawdziwa rodzina zginęła w katastrofie lotniczej. Po ich śmierci przeniosłem się z [old_city] do [city], gdzie rozpocząłem nowe życie."
...
translate crowdin presentations_c48a2b2d:
    ...
    "{color=#ec5c09}Patreon" "Niektóre postacie są wciąż w fazie rozwoju. O ich wyglądzie zadecyduję za pomocą {b}publicznych głosowań{/b}. Sprawdź mojego {b}{a=https://www.patreon.com/posts/revisiting-of-37922891}Post{/b}

# game/labels/first_day.rpy:20
translate crowdin presentations_52b3d4ce:

    # mc "For me they are a second family." nointeract
    mc "Dla mnie są drugą rodziną." nointeract
...
translate crowdin presentations_059a5711:
    ...
    mc "[jn] jest żonaty z [emy], dla mnie jest jak drugi ojciec. Jest byłym marynarzem wojskowym, po ostatniej misji w [jnMission] przeszedł na emeryturę. [jnMission] zmieniła go, zaczął pić, nigdy nie ma go w domu a jak jest to mówi bardzo mało. [emy] próbowała mu pomóc, ale tylko kłócili się i obrażali.”
...
translate crowdin presentations_f9938f03:
    ...
    mc "[arn] jest w tym samym wieku co ja, uczęszczamy do tej samej szkoły {b}{/b} i jesteśmy na tym samym roku, ale w różnych klasach. Jej klasa jest najlepsza w historii naszej szkoły, podczas gdy moja jest prawdopodobnie najgorsza. Dlatego 2 dni temu wyjechali na wycieczkę szkolną, podczas gdy my nie byliśmy”
...
translate crowdin presentations_d32b7d45:
    ...
    mc "[vct] {b}jest na pierwszym roku studiów {/b}, lubi wychodzić wieczorem i bawić się ze znajomymi. Ostatnie kilka dni było również trudnych dla niej i często wraca całkowicie {b}pijana {/b} wieczorem. Nasz relacje to głównie miłość i nienawiść”
...
translate crowdin presentations_4a1cf873:
    ...
    mc "[mia] jest najmłodsza w domu i jest ukochanym dzieckiem [for_emyR.MClabel]. Od kiedy zmieniła szkołę, ma wiele trudności i często prosi mnie o pomoc {b}w pracy domowej {/b}. Jej wielkim marzeniem jest stać się [influencer], ale [for_emyR.MClabel] zakazuje jej publikowania zdjęć."
...
translate crowdin presentations_montell_a12d227b:
    ...
    mc "{i}Teraz jestem w drodze do domu, po spędzeniu nocy u {b}[tamI.sname]{/b}. To jedyni ludzie z mojego starego życia, z którymi wciąż mam kontakt. Obok mnie jest:"
...
translate crowdin presentations_montell_ec00e90a:
    ...
    mc "{i} to jest jego matka, [tam]. Oni też stracili kogoś w katastrofie lotniczej, jego ojca i męża {b}Pan. [mrJohnson] Johnson{/b}. On i mój ojciec byli kolegami i dlatego znałem ich od dzieciństwa.”
...
translate crowdin presentations_montell_adab5526:
    ...
    mc "{i}I tak kilka tygodni po tym, jak opuściłem moje stare miasto, woleli rozpocząć nowe życie, przeprowadzając się tutaj, do mojego sąsiedztwa, z wyjątkiem jego brata, który wolał zostać.”
...
translate crowdin presentations_montell_24b5f748:
    ...
    mc "{i}Ta okolica to fajne miejsce do życia, spokojna okolica, niedaleko morze, kilka klubów i piękne dziewczyny ”
...
translate crowdin presentations_montell_d0f687c5:
    ...
    tam "Co jest nie tak z wami!? Jesteście tak cicho."
...
translate crowdin presentations_montell_9dd18ea9:
    ...
    bff "Wszystko jest dobrze. Po prostu wczoraj graliśmy na [console] do bardzo późna.”

# game/labels/first_day.rpy:68
translate crowdin presentations_montell_83e1e81c:

    # tam "Who won in the end?"
    tam "Kto wygrał w końcu?”
...
translate crowdin presentations_montell_63e9c220:
    ...
    bff "Wygrałem, dosłownie go zniszczyłem. On jest strasznie słaby.”

# game/labels/first_day.rpy:70
translate crowdin presentations_montell_c624707d:

    # mc "It's just luck."
    mc "To zwykłe szczęście."
...
translate crowdin presentations_montell_93dbb65a:
    ...
    bbf "Skromnie to talent, musisz trenować, aby osiągnąć mój poziom."
...
translate crowdin presentations_montell_60438f94:
    ...
    tam "Yea! [bff] spędza godziny przed ekranem po szkole.”
...
translate crowdin presentations_montell_e1df17f8:
    ...
    mc "Nie martw się, [tam]. Namawiam go, żeby wyszedł. Dołączyliśmy również do drużyny szkolnej [mcSport].”
...
translate crowdin presentations_montell_ce5abb14:
    ...
    bff "Nie wiem, czy to był dobry pomysł, mamo, wiesz, że nie wychodzę zbyt często, ponieważ nie mam tu wielu przyjaciół ”
...
translate crowdin presentations_montell_78aecda6:
    ...
    tam "Nie martw się, kochanie. Jestem pewna, że kiedy zaczniesz z [mcSport] zdobędziesz kilku przyjaciół.”
...
translate crowdin prologue_a1451e33:
    ...
    mc "{i}Moja [emyR.NPClabel] płacze!?"
...
translate crowdin prologue_556502aa:
    ...
    emy "On odszedł... [jn] odszedł. Dziś rano obudziłam się i go nie było. Wyszedł, nie mówiąc mi o tym.”
...
translate crowdin prologue_466e88ad:
    ...
    emy "Eh, co ja tam wiem. On wyszedł po prostu z domu."
...
translate crowdin prologue_1d85bbe3:
    ...
    mc "Oh w końcu! Nie mogłem już tego znieść.”
...
translate crowdin prologue_86435f9b:
    ...
    emy "Nie, nie, kochanie, po prostu pokłóciliśmy się jak zwykle. Wiesz, że od czasu powrotu z [jnMission] stał się inną osobą.”
...
translate crowdin prologue_c2a201c9:
    ...
    mc "Wczoraj próbowałem ukryć [jnAlcol], ale było to nie skuteczne. Znalazł go i upił się jeszcze bardziej niż zwykle ”
...
translate crowdin prologue_d1ae86a6:
    ...
    emy „Kochanie, wiesz, próbowałam mu pomóc, ale wczoraj nie mogłam już tego znieść. Powiedziałam mu, że może robić, co chce, ale to nie jest dom dla ćpunów ani alkoholików. I jeśli chce kontynuować musi odejść."
...
translate crowdin prologue_a1ba1e66:
    ...
    mc "OK, [emyR.NPClabel]. Teraz jestem trochę zmęczony, idę do swojego pokoju ”

# game/labels/first_day.rpy:216
translate crowdin prologue_eaf16fc3:

    # emy "I've kept you long enough, go ahead."
    emy "Trzymałam cię wystarczająco długo, śmiało."
...
translate crowdin prologue_end_10bae983:
    ...
    mc "{i}Cholera! Sam mam wystarczająco dużo problemów, nie potrzebuję kolejnych”
...
translate crowdin prologue_end_6e9f6796:
    ...
    mc "{i}Kto wie, jak się ma [mia]?! Może powinienem z nią porozmawiać, może powie mi coś więcej."

# game/labels/first_day.rpy:225
translate crowdin prologue_end_46b4346e:

    # mc "But first:" nointeract
    mc "Ale najpierw:" nointeract
...
translate crowdin introD_emy_94d4383a:
    ...
    "Na razie najlepiej zostawić ją w spokoju. Mógłbym porozmawiać z [mia]..."
...
translate crowdin introD_part2_43a08131:
    ...
    mia "Ehilà, Tak... sprawdzałam, że jutro mam test z matematyki."
...
translate crowdin introD_part2_19139ee8:
    ...
    mia "To znaczy, matematyka nie jest moją mocną stroną."
...
translate crowdin introD_part2_43576ccf:
    ...
    mc "Masz chwilę? Chciałam porozmawiać trochę o [emyR.NPClabel]."
...
translate crowdin introD_part2_e0a3bfeb:
    ...
    mia "Tak, wiesz o ostatniej nocy? O tym... co się stało."
...
translate crowdin introD_part2_cd9c4194:
    ...
    mia "Wczoraj wieczorem podsłuchałam, jak [emy] i [jn] rozmawiali o swoim związku... ich problemach..."

# game/labels/first_day.rpy:289
translate crowdin introD_part2_33e3f8c6:

    # mc "Same as other days, nothing new."
    mc "To samo co w inne dni, nic nowego."
...
translate crowdin introD_part2_48358ee2:
    ...
    mia "Myślałam, że to włamywacz albo ktoś o złych zamiarach, ale to był głos [jn]. Wbiegłam do salonu, ale wtedy już nikogo tam nie było. Z wyjątkiem kartki na lodówce... był... był na nim napis..."
...
translate crowdin introD_part3_50a6ef0c:
    ...
    mia "Ona już wszystko wie, napisałam jej, co się stało. Wczoraj zatrzymała się na uczelni. Współlokatorka jej przyjaciółki była u jej rodziców, więc miała dodatkowe łóżko."

# game/labels/first_day.rpy:303
translate crowdin introD_part3_1dea11ed:

    # mc "And then what happened? Did you talk to [emy]?"
    mc "I co się wtedy stało? Rozmawiałaś z [emy]?"
...
translate crowdin introD_part3_65d3fbce:
    ...
    mia "Co mogłam zrobić, odłożyłam kartkę na miejsce i wróciłam do łóżka. Nie zmrużyłam oka ostatniej nocy."
...
translate crowdin introD_part3_7ca3cff3:
    ...
    mia "Następnego dnia widać było, że [emy] płakała, ale nie wiedziałam, co robić. Starała się udawać że nic się nie stało."
...
translate crowdin introD_part3_f56be986:
    ...
    mia "Zjadłam śniadanie i zostałam w swoim pokoju. Do obiadu trochę doszła do siebie. Powiedziała mi tylko, że [jn] nie będzie przez jakiś czas. Wiesz, że nie rozmawia ze mną o takich sprawach."

# game/labels/first_day.rpy:308
translate crowdin introD_part3_7a596e35:

    # mc "OK, OK, that's enough."
    mc "OK, OK, to wystarczy."
...
translate crowdin introF_f20485b0:
    ...
    emy "Cholera! Jest już tak późno! Idę...zrobić coś...w kuchni. Mam coś w piekarniku..."

# game/labels/first_day.rpy:382
translate crowdin introF_3b5aecea:

    # emy "[mia], come down and come help me."
    emy "[mia], zejdź na dół i przyjdź mi pomóc."
...
translate crowdin introF_c6cd59e7:
    ...
    mc "{i}Kurwa nakryła mnie! Kto wie, co [emy] musiał sobie myśleć."
...
translate crowdin introF_85e719f8:
    ...
    emy "{i}O mój Boże, [emy] dlaczego nie założyłaś stanika. Gdybyś to zrobił, nie... widział... to wybrzuszenie w jego spodniach. Nie chcę już o tym myśleć więcej."

# game/labels/first_day.rpy:386
translate crowdin introF_f546882c:

    # emy "{i}I didn't think he was that gifted though."
    emy "{i}Nie sądziłam że jest tak obdarzony."
...
translate crowdin intro_sleep_2d6660c3:
    ...
    mc "{i}Co za dziwny dzień. Po tym wszystkim, co mi się przytrafiło, ciągle myślę o tym, co powiedział ten stary człowiek. Życie jest tylko jedno, nie wolno mi go zmarnować."
...
translate crowdin intro_victoria_67a1631f:
    ...
    mc "{i}O kurwa! Ktoś tam jest. Ten głos... jest znajomy."
...
translate crowdin intro_victoria_3bc62212:
    ...
    mc "{i}Czy to Viktoria? Wow, pierwszy raz widzę ją tak pijaną. Miła mała rudowłosa przyjaciółka."

# game/labels/first_day.rpy:467
translate crowdin intro_victoria_3b9f032e:

    # vct "Ha, haha... I'm drunk. Is this my house? Or yours?"
    vct "Ha, haha... Jestem pijana. To mój dom? Czy twój?"
...
translate crowdin intro_victoria_00822e71:
    ...
    vct "Ha, haha... Żartuję. Wiem, że jestem zabawna. Ta noc jest jeszcze młoda. Wypijemy jeszcze dwa piwa, a potem pójdziemy rzucać butelkami w jakieś samochody."

# game/labels/first_day.rpy:469
translate crowdin intro_victoria_52a19ad2:

    # "Red girl" "But if you can't even stand up. Ha, haha..."
    "Red girl" "Ale jeśli nie możesz nawet wstać. Ha, haha..."

# game/labels/first_day.rpy:472
translate crowdin intro_victoria_453896e9:

    # mc "{i}Better get back to bed today was a rough day."
    mc "{i}Lepiej wracać do łóżka dziś był ciężki dzień."
...
translate crowdin intro_victoria_7861e7b2:
    ...
    vct " Hej! [krn] nie mów mi co mogę a czego nie mo... ... O mój boże jak to szło? A już! A czego nie mogę."
...
translate crowdin intro_victoria_ddcec8e8:
    ...
    vct "Teraz ty, piękna. Ty zostań tutaj. A ja idę po te cholerne piwa. A kiedy wrócę, zróbmy to, co powiedziałam."
...
translate crowdin intro_victoria_291a865c:
    ...
    "([vct] próbuje chodzić o własnych siłach, ale nie może zrobić ani jednego kroku i upada z powrotem na Kristen)

# game/labels/first_day.rpy:483
translate crowdin intro_victoria_d9ef6e38:

    # krn "Look out! [vct], are you okay?"
    krn "Uważaj! [vct], wszystko w porządku?"
...
translate crowdin intro_victoria_e04c2959:
    ...
    vct "Okay, okay. Przyznaję się. Jestem trochę zbyt pijana. Wygrałaś. A teraz zróbmy co chcesz."

# game/labels/first_day.rpy:485
translate crowdin intro_victoria_c641bf7b:

    # krn "I'd better take you to your room now."
    krn "Lepiej zaprowadzę cię teraz do twojego pokoju."
...
translate crowdin intro_victoria_bc2b5968:
    ...
    mc "{i}O mój Boże, to nie może się dziać naprawdę. Co mam teraz zrobić:" nointeract

# game/labels/first_day.rpy:492
translate crowdin intro_victoria_04cdc7e5:

    # mc "{i}Better intervene before it gets too late."
    mc "{i}Lepiej interweniować, zanim będzie za późno."
...
translate crowdin intro_victoria_abba356b:
    ...
    vct "Daj spokój. Wiem to. Cały czas byłaś do mnie przyklejona."
...
translate crowdin morning_intro_part2_7f39c00d:
    ...
    krn "Hej, um tak... [vct] trochę za dużo wypiła, więc ją podwiozłam."
...
translate crowdin morning_intro_part2_879b45c8:
    ...
    mc "One się rozumieją. Przepraszam, że się nie przedstawiłem. Jestem [mc], [vctR.MClabel] [vct]."
...
translate crowdin morning_intro_part2_ba07746f:
    ...
    krn "[krn]. Miło Cię poznać. [vct] opowiadał mi o was, wiem, że ostatnio nie mieliście lekko, że mieliście wzloty i upadki."

# game/labels/first_day.rpy:534
translate crowdin morning_intro_part2_86bd746d:

    # mc "Already more downs than ups."
    mc "Teraz już więcej upadków niż wzlotów."
...
translate crowdin morning_intro_part2_3c4c60da:
    ...
    vct "Hej. [krn], to [mc], mój [vctR.MClabel]. Przepraszam, zapomniałam... już się sobie przedstawiliście."

# game/labels/first_day.rpy:536
translate crowdin morning_intro_part2_5c26ecb9:

    # mc "You go to college together?"
    mc "Chodzicie razem do college'u?"
...
translate crowdin morning_intro_part3_03f8bb43:
    ...
    mc "Jesteś stąd? Chcesz zostać na noc?"
...
translate crowdin morning_intro_part3_a4876634:
    ...
    krn "Nie dzięki. Jestem z północy [city], ale mieszkam w akademiku."
...
translate crowdin morning_intro_part3_082bde9b:
    ...
    mc "{i}Wow, ona jest nawalona w trupa. Powinienem zabrać ją do łóżka! Ale chyba nie dam rady, ona jest większa ode mnie."

# game/labels/first_day.rpy:570
translate crowdin morning_intro_part3_3c1639fb:

    # mc "{i}Whatever, she's asleep now."
    mc "{i}Nieważne, ona już śpi."

translate crowdin strings:

    # game/labels/first_day.rpy:20
    old "Rename the characters"
    new "Zmień nazwę postaci"

    # game/labels/first_day.rpy:20
    old "More about my family"
    new "Więcej o mojej rodzinie"

    # game/labels/first_day.rpy:20
    old "Continue with the intro"
    new "Kontynuuj z intro"

    # game/labels/first_day.rpy:161
    old "Where did he go?"
    new "Gdzie on poszedł?"
    ...
    new "{color=#000}{size=120}{font=fonts/handwriting_alphabetizedcassettetapes-classic.ttf}Moja obecność \n powoduje tylko problemy. \n Naprawię nasz problem, \n ale wtedy nie wrócę. \n\n   [jn]{/color}"
    ...
    new "Co się stało? {color=#f00}(Prawdopodobieństwo10%%)"
