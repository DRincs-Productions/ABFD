...
translate crowdin strings:
    ...
    new "[jn] odszedł zostawiając nas samych. W liście który zostawił napisał że musi załatwić pewne problemy, ale jakie? Poza tym niewiele więcej wiem, z drugiej strony [emy] zdaje się wiedzieć, o czym mówił, a raczej nie zadaje zbyt wielu pytań, jakby już wiedziała o odpowiedziach. \n Mam tylko nadzieję, że problemy nie będą nas szukać."
