...
translate crowdin News01_04f7d3a9:
    ...
    emy "Tak! Ale teraz żeby pracować w tym macho TV wystarczy wiedzieć z kim spać... Dlatego miała tak dużo praktyk w liceum."
...
translate crowdin News01_0eda7e25:
    ...
    mc "{i}Wow, nigdy nie słyszałem, żeby [emy] tak mówiła. Musiały być wrogami w liceum."
...
translate crowdin News01_a580f33b:
    ...
    mia "Eh... [for_emyR.MClabel] nie rozumiem. Jak zaczynałaś? Może ja też bym mogła to zrobić, żeby zostać sławną."
...
translate crowdin News01_1516aec4:
    ...
    emy "Haha... [mia]... jesteś jeszcze za młoda, żeby to zrozumieć. Nie musisz być taka jak ona, żeby stać się sławną."
...
translate crowdin News01_94e3957f:
    ...
    nnc "Dobry wieczór, widzowie z [city]. Przerwaliśmy normalną transmisję na żywo, aby zgłosić strzelaninę w [city] na północy."
...
translate crowdin News01_623d2a9f:
    ...
    nnc "Interweniowała już policja. Policja podejrzewa, że strzelanina, do której doszło, to starcie między dwoma gangami, ale przyczyna wciąż nie jest jasna."
...
translate crowdin News01_2bed67ba:
    ...
    nnc "Niektóre źródła podają, że gangi te zamierzają sprzedawać nowe narkotyki na czarnym rynku."

# game/labels/tv.rpy:81
translate crowdin News01_dae2e0b6:

    # mia "Oh no! [for_jnR.MClabel] is out there by himself...."
    mia "Oh no! [for_jnR.MClabel] jest tam sam…”
...
translate crowdin News01_0a0aaa8b:
    ...
    emy "Tak! Nie chcę, żeby coś jej się stało. Ale [for_emyR.NPClabel], nie martw się. Widział gorsze rzeczy niż mała strzelanina."
...
translate crowdin News01_42879e7a:
    ...
    nnc "Wykorzystujemy ten czas, aby ogłosić również inne wiadomości.... bla bla...."
