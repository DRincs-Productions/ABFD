...
translate crowdin first_at_table_preparation_bba393c8:
    ...
    emy "Ok. c'est prêt, allons dîner."
...
translate crowdin at_table_dinner_A_c8876fdc:
    ...
    emy "Désolé chérie, je ne t'ai même pas demandé comment il s'est passé chez [bff] aujourd'hui."

# game/labels/at_table.rpy:96
translate crowdin at_table_dinner_A_1c5dc3b7:

    # mc "Don't apologize, you don't have to."
    mc "Ne t'excuses pas, tu n'as pas à le faire."
...
translate crowdin at_table_dinner_A_55e2a73e:
    ...
    mc "Hier... Si je me souviens bien... Nous avons joué à [console], et on a un peu parlé de l'école et du bon vieux temps"

# game/labels/at_table.rpy:98
translate crowdin at_table_dinner_A_c223c518:

    # emy "What did you guys eat?"
    emy "Qu'est-ce que vous avez mangé?"
...
translate crowdin at_table_dinner_A_2cc787ab:
    ...
    emy "Toi et [bff] avez une bonne amitié, vous semblez presque comme des frères. Même si vous êtes très différent." nointeract
...
translate crowdin at_table_dinner_A_9c64c2df:
    ...
    mc "Ouais, nous sommes très proches. Je le connais depuis longtemps et puis nous avons un passé très similaire."
...
translate crowdin at_table_dinner_A_bef7a488:
    ...
    mia "[old_city] te manque? Je veux dire que tu as quitté tout le monde que tu connaissais."
...
translate crowdin at_table_dinner_A_e6bdb60e:
    ...
    mia "Mhmm, oui... mais... le professeur est trop strict. Je suis sûr qu'il me déteste."

# game/labels/at_table.rpy:124
translate crowdin at_table_dinner_A_aaa8f66c:

    # emy "Haha... yes of course, of course."
    emy "Haha... oui bien sûr, bien sûr."
...
translate crowdin at_table_dinner_A_215aa469:
    ...
    mc "Super dîner. tout est parfait."
