...
translate crowdin intro_wach_tv_5ec12594:
    ...
    mc "Prima vado a lavarmi i denti."
...
translate crowdin intro_wach_tv_f444af27:
    ...
    "Pubblicità" " Vuoi avere una vita migliore? Vuoi davvero goderti la vita? Sia in spiaggia che in montagna?"
...
translate crowdin intro_wach_tv_b9a975e6:
    ...
    "TV" "interrompiamo la trasmissione, per trasmettere una diretta straordinaria di [city] news."

# game/labels/tv.rpy:61
translate crowdin intro_wach_tv_b9e94afd:

    # mia "Phew, I wanted to see the movie."
    mia "Uffi, volevo vedere il film."
...
translate crowdin News01_4c069dcb:
    ...
    mia "Guarda [for_emyR.MClabel]! C'è [nnc]. Era una ex compagna di classe di [for_emyR.MClabel]."
...
translate crowdin News01_04f7d3a9:
    ...
    emy "Già! By now, all you have to do to work in this macho TV is sleep with the right people... That's why he had so much practice in high school in high school."
...
translate crowdin News01_0eda7e25:
    ...
    mc "{i}Wow, non ho mai sentito [emy] dire una cosa del genere. Devono essere state rivali al liceo."
...
translate crowdin News01_1516aec4:
    ...
    emy "Haha... [mia]... sei ancora troppo piccola per capire queste cose. Tu non devi essere come lei per diventare famosa."
...
translate crowdin News01_94e3957f:
    ...
    nnc "Buonasera, telespettatori di [city]. Abbiamo interrotto la normale trasmissione perché per segnalare una sparatori ad [city] nord."
...
translate crowdin News01_623d2a9f:
    ...
    nnc "E' già intervenuta la polizia. La polizia sospetta che la sparatoria che si è verificata sia lo scontro tra due gruppi, ma la ragione è ancora poco chiara."
...
translate crowdin News01_2bed67ba:
    ...
    nnc "Alcune fonti dicono che queste bande stanno per vendere nuove droghe sul mercato nero."

# game/labels/tv.rpy:81
translate crowdin News01_dae2e0b6:

    # mia "Oh no! [for_jnR.MClabel] is out there by himself...."
    mia "Oh no! [for_jnR.MClabel] è là fuori da solo...."
...
translate crowdin News01_0a0aaa8b:
    ...
    emy "Già! Non voglio che gli succeda qualcosa. Ma [for_emyR.NPClabel], non preoccuparti. Ha visto cose peggiori di una piccola sparatoria."
...
translate crowdin News01_42879e7a:
    ...
    nnc "Ne approfittiamo per proseguire con altre notizie.... bla bla...."
