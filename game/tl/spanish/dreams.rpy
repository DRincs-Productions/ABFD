...
translate crowdin after_deathA_61e42010:
    ...
    "(Desde el pc del viejo, se empieza a escuchar un sonido muy tenue)"
...
translate crowdin after_deathA_cca01962:
    ...
    "Cronist" "... Maradona arranca desde el centro del campo... va por el gol... y es... ¡¡¡GOL!!! ¡¡¡GOL!!! Maradona marca un Hat-Trick."
...
translate crowdin after_deathA_3f3a72e0:
    ...
    "Cronist" "Este es el final de este legendario partido. El resultado es 6-0..."
...
translate crowdin after_deathA_partA_84dffed7:
    ...
    "old man" "Pensé que eras más inteligente. Creo que puedes descubrirlo por ti mismo."

# game/labels/dreams.rpy:53
translate crowdin after_deathA_partA_4cf36064:

    # mc "Can I meet any famous people?"
    mc "¿Puedo ver a algún famoso?"
...
translate crowdin after_deathA_partA_da8e88e9:
    ...
    "old man" "No, lo siento. No puedes tener acceso a esa zona, es un área restringida."

# game/labels/dreams.rpy:57
translate crowdin after_deathA_partA_58dd5a2f:

    # mc "No further questions."
    mc "No hay más preguntas."
...
translate crowdin after_deathA_partA_6842a21a:
    ...
    "old man" "Ok... Encontré su archivo... [mc] de [mcI.age] años..."
...
translate crowdin after_deathA_partA_8574059a:
    ...
    "old man" "Huefano, todavía virgen, sin ganas de esforzarse, sin buenas/malas acciones en particular.... Nada en especial."
...
translate crowdin after_deathA_partA_9880a557:
    ...
    "old man" "Mhmm... interesante... aún no han tomado ninguna decisión. Así que... Debería inspeccionar cuidadosamente tu expediente."
...
translate crowdin after_deathA_partA_eb4260d9:
    ...
    "old man" "{i}Casi he terminado mi turno. Ouch, otra consulta. Debería quedarme unas horas más."
...
translate crowdin after_deathA_partA_17890281:
    ...
    "old man" "¡Tengo una idea! Chico, ven conmigo."
...
translate crowdin after_deathA_partA_4f9973d8:
    ...
    "old man" "Ven, acércate. No tengas miedo, no voy a morder. Puedes ver el mundo entero desde aquí arriba. Y justo aquí abajo está tu barrio."
...
translate crowdin after_deathA_partA_921836c8:
    ...
    mc "¡Oh! ¡Wow! Esta vista es aterradora e impresionante al mismo tiempo."
...
translate crowdin after_deathA_partA_e39dd78c:
    ...
    "old man" "Chico escucha a un viejo que tiene un poco más de experiencia que tú. Aquí arriba es un lugar extremadamente aburrido, todo es muy repetitivo. No tienes libertad de elección."
...
translate crowdin after_deathA_partA_b6d5f379:
    ...
    "old man" "Mientras que allí abajo... Eh, no hay límite ahí abajo. Sólo el límite de tu imaginación."
...
translate crowdin after_deathA_partA_fc07b605:
    ...
    "old man" "Puedes hacer lo que quieras. Drogas, alcohol, sexo ... o si te hace sentir mejor puedes ayudar a la gente. La elección es sólo tuya. No deberías haber perdido todo este tiempo reflexionando sobre tu pasado, sino pasando a la acción."

# game/labels/dreams.rpy:73
translate crowdin after_deathA_partA_6ce9249c:

    # mc "Yeah, too bad I can't do that anymore."
    mc "Sí, qué pena que ya no pueda hacerlo."
...
translate crowdin after_deathA_partA_b497c4a2:
    ...
    "old man" "Si te inclinas un poco más, puedes ver tu cuerpo desde aquí arriba."
...
translate crowdin after_deathA_partA_3fff85fb:
    ...
    "old man" "Otro caso resuelto. Justo a tiempo para el cambio de turno."

translate crowdin strings:

    # game/labels/dreams.rpy:17
    old "But I'm the only one."
    new "Pero soy el único."
    ...
    new "{size=120}Unas horas después."
